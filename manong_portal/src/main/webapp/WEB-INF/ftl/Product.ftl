...
<div class="topBar">
  <div class="comWidth">
    ...
    <div class="rightArea fr"> 喵!欢迎来到码农商城！ <a href="#" class="">[登录]</a><a href="#" class="">[免费注册]</a> </div>
  </div>
</div>
<!----logo区-------------------------------------------->
<div class="logoBar">
  ...
  <div class="Products_show">
        ...
        <div class="Products_list">
           ...
           <div class="Products_item">
                <div class="item_img"><a href="#"><img src="http://144.202.106.234:8888/${product.imgUrl}" alt="手机" width="200px"/></a></div>
                <div class="item_cont">
